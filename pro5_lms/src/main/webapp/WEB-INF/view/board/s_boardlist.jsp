        ...
        <div class ="container">
            ...
            <div class="incontain">
                ...
                <div class = "select_form">
                	<form action="http://localhost:8080/pro5_lms/board/ListAction2">
                ...
                <div class="posts">
                 <div class="table">
                     ...
                     <ul class="tr">
                         ...
                         <!-- 수정하기 -->
                         <li class="td c"><a href="http://localhost:8080/pro5_lms/board/s_post?num=<%=dto.getPo_num()%>&pageNum=<%=pageNum%>"><%=dto.getPo_subject()%></a></li>
                 ...
                 <div class="pages">
                    ...
                    %>
                    	<div class="left"><a href="http://localhost:8080/pro5_lms/board/ListAction2?pageNum=<%=pageNum-1%>&subjects=<%=search%>"><i class="fa-solid fa-angle-left"></i></a></div>
                    <% 	
                    }
                     	for(int j =start; j<=end; j++){
                     		if (j == pageNum){
                     %>
                     <div class="number"><a href="http://localhost:8080/pro5_lms/board/ListAction2?pageNum=<%=j%>" style="color:black;"><%=j %></a></div>
                    <%
                     		}
                     		else{
                    %>
          			<div class="number"><a href="http://localhost:8080/pro5_lms/board/ListAction2?pageNum=<%=j%>"><%=j %></a></div>
           			<%
                     		}
                     	}
                    ...
                    %>
                    <div class="right"><a href="http://localhost:8080/pro5_lms/board/ListAction2?pageNum=<%=pageNum+1%>&subjects=<%=search%>"><i class="fa-solid fa-angle-right"></i></a></div>
                    <% 	
                    }
                    %>
                 </div>
