        ...
        <div class ="container">
            ...
            <div class="frame">
                ...
                <div class="frame_bottom">
                    <form action="http://localhost:8080/pro5_lms/board/p_postupload" class="post-form" name="write_form" method="post" enctype="multipart/form-data">
                        <input name="id" type="hidden" value="${remember.getId()}">
