...
<!--기본 틀 안에 내용 작성-->
        <div class ="container">
            ...
            <form class="incontain" action = "s_noticeboardlist">
                <div class="p-contain">
             ...
             <div class="posts">
                     ...
                     %>
						<ul class = "tr">
							<li class = "td a"><p><%= nbDTO.getN_num() %></p></li>
	                     	...
	                     	<li class = "td c"><a href = "http://localhost:8080/pro5_lms/board/s_notice?n_num=<%=nbDTO.getN_num()%>&pageNum=<%=pageNum%>"><%=nbDTO.getN_subject()%></a></li>
                 ...
                 <div class="pages">
                 	...
                 	<c:forEach var="i" begin="1" end="<%=total_page%>">
                 		<div class="number">
	                 		<a href="<c:url value="/board/s_noticeboardlist?pageNum=${i}" /> ">
		                 		<c:choose>
