                    ...
                    <div class="select_item">
                        ...
                        <script>
                        	function sub_student(obj) {
                        		document.subjectForm.action = "http://localhost:8080/pro5_lms/professor/p_score.per?subject="+obj.value;
                            ...
                            <select name="student" id="student">
                                <%
                                	for(int i=0; i<st_list.size(); i++){
                                		...
                                		if (!s_id.equals("null") &&s_id != null && sDTO.getS_id() == Integer.valueOf(s_id)) {
                                %>
                        ...
                        <script>
                        	function sub_score() {
                        		...
                        		document.search_scoreForm.action = "http://localhost:8080/pro5_lms/professor/getScore.per?student="+stdn.options[stdn.selectedIndex].value+"&subject="+subj.options[subj.selectedIndex].value;
