                    ...
                    <div class = "left">
                        ...
                        <div class = "ul_container">
                            <ul>
                           	...
                           	%>
                           		<li><div class="list"><%= nbDTO.getN_num() %></div><a href="http://localhost:8080/pro5_lms/board/p_notice.notice?num=<%=nbDTO.getN_num()%>&pageNum=<%=nbPageNum%>"><%=nbDTO.getN_subject()%></a></li>
                           	<%
                           		}
                           	%>
                            </ul>
